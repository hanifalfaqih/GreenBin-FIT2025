...
class ListArticleAdapter(private val articleId: (Int) -> Unit): ListAdapter<ArticleItem, ListArticleAdapter.ArticleViewHolder>(ArticleComparator()) {
    override fun onCreateViewHolder(
        ...
        val binding =   ArticleItemCardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ArticleViewHolder(private val binding: ArticleItemCardBinding): RecyclerView.ViewHolder(binding.root) {
